...
<form method="POST" action="<?= url('invoices') ?>" id="invoice-form">
    ...
    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <select class="form-select" id="product-select" onchange="addProductToInvoice()">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subject" name="subject" placeholder="z.B. Rechnung für Dienstleistungen">
                    </div>

                    <div class="mb-3">
                        <label for="intro_text" class="form-label">Einleitungstext</label>
                        <textarea class="form-control" id="intro_text" name="intro_text" rows="3" placeholder="vielen Dank für Ihren Auftrag. Wir berechnen Ihnen wie folgt:"></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="outro_text" class="form-label">Schlusstext</label>
                        <textarea class="form-control" id="outro_text" name="outro_text" rows="3" placeholder="Wir bedanken uns für Ihren Auftrag und freuen uns auf eine weitere Zusammenarbeit."></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header bg-white">
                    <h5 class="mb-0"><i class="bi bi-calendar"></i> Rechnungsdaten</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="delivery_date" class="form-label">Leistungsdatum</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" step="0.01" class="form-control" id="skonto_percent" name="skonto_percent" value="<?= DEFAULT_SKONTO_PERCENT ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <textarea class="form-control" name="notes" rows="3" placeholder="Interne Notizen (nicht auf der Rechnung sichtbar)"></textarea>
                </div>
            </div>
            ...
            <div class="d-grid gap-2">
                ...
                <a href="<?= url('invoices') ?>" class="btn btn-outline-secondary">Abbrechen</a>
            </div>
        </div>
    </div>
</form>
